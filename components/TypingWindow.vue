  ...
  <div class="main-window" @click="startTest">
    <div class="words-container" ref="words-container">
      ...
      <div v-for="word in words" :key="word" ref="words" class="word">
        <div v-for="letter in word" :key="letter" ref="letters" class="letter"><span>{{ letter }}</span></div>
  ...
  export default {
    ...
    methods: {
      ...
      moveCaret() {
        ...
        let currentLetter = currentWord.querySelectorAll('.letter')[this.currentLetterIndex]   
